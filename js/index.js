...
var recipes = typeof localStorage["recipeBook"] != "undefined" ? JSON.parse(localStorage["recipeBook"]) : [{ title: "Apple Pie", ingredients: ["Apple Puree", "Sweetened Condensed Milk", "Eggs", "Apple Pie Spice", "Pie Crust"] }, { title: "Coscous", ingredients: ["Coscous", "Tomato Sauce", "(Optional) Meat"] }, { title: "Cheese cake", ingredients: ["Cheese", "Cake Crust", "Yeey !!"] }],
    globalTitle = "",
